    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (memberRepository.count() <= 0 && hotelRepository.count() <= 0) {
            IntStream.rangeClosed(1, 50).forEach(i -> {
                ...
                hotel.addImage(new Image("test" + i, "test" + i, "https://kr.object.ncloudstorage.com/hotsix.accomodation.bucket/ACCOMMODATION/2024/02/ACCOMMODATION_123_1afd0e02-780f-4732-8d62-a7453667d9de_pension1.jpg", 30L));
